...
export const renderGQ16 = ({
  color = 'currentColor',
  className,
}: IconProps) =>
  html`<svg viewBox="0 0 23 16" width="23" height="16"
       fill="${color}" class="${className ?? ''}" aria-hidden="true" focusable="false">
    ${unsafeHTML(`<rect width="22.4" height="16" fill="url(#pattern0_2072_1738)"/>
<defs>
<pattern id="pattern0_2072_1738" patternContentUnits="objectBoundingBox" width="1" height="1">
<use xlink:href="#image0_2072_1738" transform="scale(0.015873 0.0222222)"/>
</pattern>
