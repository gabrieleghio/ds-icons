...
export const ProductCatalogueSingleLayoutFilled24 = ({
  color = 'currentColor',
  className,
  style,
}: IconProps) => (
  <svg viewBox="0 0 24 24" width={24} height={24}
    ...
    <path d="M21.9007 1.2251H2.1007C1.61469 1.2251 1.2207 1.61909 1.2207 2.1051V10.4451C1.2207 10.9311 1.61469 11.3251 2.1007 11.3251H21.9007C22.3867 11.3251 22.7807 10.9311 22.7807 10.4451V2.1051C22.7807 1.61909 22.3867 1.2251 21.9007 1.2251Z" fill="black"/>
