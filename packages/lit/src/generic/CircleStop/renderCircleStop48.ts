...
export const renderCircleStop48 = ({
  color = 'currentColor',
  className,
}: IconProps) =>
  html`<svg viewBox="0 0 48 48" width="48" height="48"
       fill="${color}" class="${className ?? ''}" aria-hidden="true" focusable="false">
    ${unsafeSVG(`<path d="M39.38 41.38C39.12 41.38 38.87 41.28 38.67 41.09L6.88 9.29C6.49 8.9 6.49 8.27 6.88 7.88C7.27 7.49 7.9 7.49 8.29 7.88L40.08 39.67C40.47 40.06 40.47 40.69 40.08 41.08C39.88 41.28 39.63 41.37 39.37 41.37L39.38 41.38Z"/>
