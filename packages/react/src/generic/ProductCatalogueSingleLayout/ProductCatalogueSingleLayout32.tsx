...
export const ProductCatalogueSingleLayout32 = ({
  ...
  <svg viewBox="0 0 32 32" width={32} height={32}
    ...
    <path d="M2.82 14.78C2.37 14.78 2 14.41 2 13.96V2.82C2 2.37 2.37 2 2.82 2H29.23C29.68 2 30.05 2.37 30.05 2.82V13.96C30.05 14.41 29.68 14.78 29.23 14.78H2.82ZM3.64 13.2L28.47 13.15L28.42 3.59L3.64 3.64V13.2Z" fill="black"/>
