...
export const renderDownloaded32 = ({
  ...
  html`<svg viewBox="0 0 32 32" width="32" height="32"
    ...
    ${unsafeHTML(`<path d="M2.82 28.68C2.37 28.68 2 28.31 2 27.86V21.1C2 20.65 2.37 20.28 2.82 20.28C3.27 20.28 3.64 20.65 3.64 21.1V27.09L28.5 27.04L28.45 21.1C28.45 20.65 28.82 20.28 29.27 20.28C29.72 20.28 30.09 20.65 30.09 21.1V27.86C30.09 28.31 29.72 28.68 29.27 28.68H2.82Z" fill="black"/>
