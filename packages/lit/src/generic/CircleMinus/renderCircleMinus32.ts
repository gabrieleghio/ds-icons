...
export const renderCircleMinus32 = ({
  ...
  html`<svg viewBox="0 0 32 32" width="32" height="32"
    ...
    ${unsafeSVG(`<g clip-path="url(#clip0_2055_412)">
<g clip-path="url(#clip1_2055_412)">
<path d="M7.91 16.67C7.46 16.67 7.09 16.3 7.09 15.85C7.09 15.4 7.46 15.03 7.91 15.03H23.76C24.21 15.03 24.58 15.4 24.58 15.85C24.58 16.3 24.21 16.67 23.76 16.67H7.91Z"/>
