...
export const ProductCatalogueSingleLayoutFilled40 = ({
  color = 'currentColor',
  className,
  style,
}: IconProps) => (
  <svg viewBox="0 0 40 40" width={40} height={40}
    ...
    <path d="M36.85 3H3.83C3.3716 3 3 3.3716 3 3.83V17.76C3 18.2184 3.3716 18.59 3.83 18.59H36.85C37.3084 18.59 37.68 18.2184 37.68 17.76V3.83C37.68 3.3716 37.3084 3 36.85 3Z" fill="black"/>
