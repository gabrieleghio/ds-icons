...
export const ZoomOutMinusShrink24 = ({
  color = 'currentColor',
  className,
  style,
}: IconProps) => (
  <svg viewBox="0 0 24 24" width={24} height={24}
    ...
    <g clip-path="url(#clip0_2055_265)">
...
<path d="M5.73 10.99C5.31 10.99 4.98 10.65 4.98 10.23C4.98 9.81 5.32 9.48 5.73 9.48H14.74C15.16 9.48 15.5 9.82 15.5 10.23C15.5 10.64 15.16 10.99 14.74 10.99H5.73Z"/>
</g>
<defs>
