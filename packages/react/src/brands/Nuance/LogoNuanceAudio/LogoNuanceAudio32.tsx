...
export const LogoNuanceAudio32 = ({
  color = 'currentColor',
  className,
  style,
}: IconProps) => (
  <svg viewBox="0 0 32 32" width={32} height={32}
    ...
    <path d="M14.2877 11.0431C20.94 10.192 21.2872 22.23 14.2673 21.5219C9.05857 20.9976 8.83388 11.7376 14.2877 11.0431Z" fill="black"/>
