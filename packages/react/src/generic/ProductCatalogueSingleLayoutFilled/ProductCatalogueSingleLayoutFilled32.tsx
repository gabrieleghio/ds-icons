...
export const ProductCatalogueSingleLayoutFilled32 = ({
  color = 'currentColor',
  className,
  style,
}: IconProps) => (
  <svg viewBox="0 0 32 32" width={32} height={32}
    ...
    <path d="M29.07 2H2.67C2.29997 2 2 2.29997 2 2.67V13.8C2 14.17 2.29997 14.47 2.67 14.47H29.07C29.44 14.47 29.74 14.17 29.74 13.8V2.67C29.74 2.29997 29.44 2 29.07 2Z"/>
