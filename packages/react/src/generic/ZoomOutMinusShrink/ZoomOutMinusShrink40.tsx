...
export const ZoomOutMinusShrink40 = ({
  color = 'currentColor',
  className,
  style,
}: IconProps) => (
  <svg viewBox="0 0 40 40" width={40} height={40}
    ...
    <g clip-path="url(#clip0_2055_259)">
...
<path d="M24.46 16.12H9.44C8.98 16.12 8.61 16.49 8.61 16.95C8.61 17.41 8.98 17.78 9.44 17.78H24.46C24.92 17.78 25.29 17.41 25.29 16.95C25.29 16.49 24.92 16.12 24.46 16.12Z"/>
</g>
<defs>
