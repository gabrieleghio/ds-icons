...
export const Downloaded16 = ({
  ...
  <svg viewBox="0 0 16 16" width={16} height={16}
    ...
    <path d="M14.85 10.16C14.5 10.16 14.22 10.44 14.22 10.79V13.54H2.26V10.79C2.26 10.44 1.98 10.16 1.63 10.16C1.28 10.16 1 10.44 1 10.79V14.17C1 14.52 1.28 14.8 1.63 14.8H14.85C15.2 14.8 15.48 14.52 15.48 14.17V10.79C15.48 10.44 15.2 10.16 14.85 10.16Z"/>
