...
export const renderInfo24 = ({
  ...
  html`<svg viewBox="0 0 24 24" width="24" height="24"
    ...
    ${unsafeSVG(`<g clip-path="url(#clip0_2055_339)">
...
<path d="M11.85 16.68C11.48 16.68 11.18 16.38 11.18 16.01V10.72C11.18 10.35 11.48 10.05 11.85 10.05C12.22 10.05 12.52 10.35 12.52 10.72V16.01C12.52 16.38 12.22 16.68 11.85 16.68Z"/>
<path d="M11.85 8.42C11.46 8.42 11.15 8.11 11.15 7.72C11.15 7.33 11.47 7.02 11.85 7.02C12.23 7.02 12.55 7.34 12.55 7.72C12.55 8.1 12.23 8.42 11.85 8.42Z"/>
</g>
<defs>
