...
export const ProductCatalogueSingleLayout24 = ({
  color = 'currentColor',
  className,
  style,
}: IconProps) => (
  <svg viewBox="0 0 24 24" width={24} height={24}
    ...
    <path d="M1.76 10.87C1.34 10.87 1 10.53 1 10.11V1.76C1 1.34 1.34 1 1.76 1H21.57C21.99 1 22.32 1.34 22.32 1.76V10.11C22.32 10.53 21.98 10.87 21.57 10.87H1.76ZM2.63 2.51C2.56 2.51 2.51 2.56 2.51 2.63V9.23C2.51 9.3 2.56 9.35 2.63 9.35H20.69C20.76 9.35 20.81 9.3 20.81 9.23V2.63C20.81 2.56 20.76 2.51 20.69 2.51H2.63Z"/>
