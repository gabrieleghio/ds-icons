...
export const ProductCatalogueSingleLayout16 = ({
  ...
  <svg viewBox="0 0 16 16" width={16} height={16}
    ...
    <path d="M1.58 7.73C1.26 7.73 1 7.47 1 7.15V1.58C1 1.26 1.26 1 1.58 1H14.79C15.11 1 15.37 1.26 15.37 1.58V7.15C15.37 7.47 15.11 7.73 14.79 7.73H1.58ZM14.2 6.56V2.16H2.16V6.56H14.2Z"/>
