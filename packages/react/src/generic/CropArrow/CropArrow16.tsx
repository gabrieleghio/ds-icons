...
export const CropArrow16 = ({
  ...
  <svg viewBox="0 0 16 16" width={16} height={16}
    ...
    <path d="M12.67 15.15C12.35 15.15 12.09 14.89 12.09 14.57V3.93H1.58C1.26 3.93 1 3.67 1 3.35C1 3.03 1.26 2.77 1.58 2.77H12.68C13 2.77 13.26 3.03 13.26 3.35V14.57C13.26 14.89 13 15.15 12.68 15.15H12.67Z" fill="black"/>
