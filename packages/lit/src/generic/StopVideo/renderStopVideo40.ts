...
export const renderStopVideo40 = ({
  ...
  html`<svg viewBox="0 0 40 40" width="40" height="40"
    ...
    ${unsafeSVG(`<g clip-path="url(#clip0_4044_36)">
...
<path d="M25.49 13.18H15.18C14.0754 13.18 13.18 14.0754 13.18 15.18V25.49C13.18 26.5946 14.0754 27.49 15.18 27.49H25.49C26.5946 27.49 27.49 26.5946 27.49 25.49V15.18C27.49 14.0754 26.5946 13.18 25.49 13.18Z"/>
</g>
<defs>
