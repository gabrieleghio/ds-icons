...
export const renderWashDryNormal24 = ({
  ...
  html`<svg viewBox="0 0 24 24" width="24" height="24"
    ...
    ${unsafeSVG(`<path d="M11.78 19.78C7.37 19.78 3.78 16.19 3.78 11.78C3.78 7.37 7.37 3.78 11.78 3.78C16.19 3.78 19.78 7.37 19.78 11.78C19.78 16.19 16.19 19.78 11.78 19.78ZM11.78 5.29C8.2 5.29 5.29 8.2 5.29 11.78C5.29 15.36 8.2 18.27 11.78 18.27C15.36 18.27 18.27 15.36 18.27 11.78C18.27 8.2 15.36 5.29 11.78 5.29Z"/>
