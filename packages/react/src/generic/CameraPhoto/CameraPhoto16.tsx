...
export const CameraPhoto16 = ({
  ...
  <svg viewBox="0 0 16 16" width={16} height={16}
    ...
    <g clip-path="url(#clip0_2055_841)">
<path d="M8.2 10.93C6.69 10.93 5.46 9.7 5.46 8.19C5.46 6.68 6.69 5.45 8.2 5.45C9.71 5.45 10.94 6.68 10.94 8.19C10.94 9.7 9.71 10.93 8.2 10.93ZM8.2 6.61C7.33 6.61 6.62 7.32 6.62 8.19C6.62 9.06 7.33 9.77 8.2 9.77C9.07 9.77 9.78 9.06 9.78 8.19C9.78 7.32 9.07 6.61 8.2 6.61Z"/>
