...
export const renderCropArrow32 = ({
  ...
  html`<svg viewBox="0 0 32 32" width="32" height="32"
    ...
    ${unsafeSVG(`<path d="M25.01 29.61C24.56 29.61 24.19 29.24 24.19 28.79V7.13L2.82 7.18C2.37 7.18 2 6.81 2 6.36C2 5.91 2.37 5.54 2.82 5.54H25.01C25.46 5.54 25.83 5.91 25.83 6.36V28.79C25.83 29.24 25.46 29.61 25.01 29.61Z"/>
