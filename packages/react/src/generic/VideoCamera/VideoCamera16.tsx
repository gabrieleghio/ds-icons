...
export const VideoCamera16 = ({
  ...
  <svg viewBox="0 0 16 16" width={16} height={16}
    ...
    <path d="M3.45 6.94C3.13 6.94 2.87 6.68 2.87 6.36C2.87 6.04 3.13 5.78 3.45 5.78H5.82C6.14 5.78 6.4 6.04 6.4 6.36C6.4 6.68 6.14 6.94 5.82 6.94H3.45Z" fill="black"/>
