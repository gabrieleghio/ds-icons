...
export const ProductCatalogueSingleLayout40 = ({
  ...
  <svg viewBox="0 0 40 40" width={40} height={40}
    ...
    <path d="M36.85 18.59H3.83C3.37 18.59 3 18.22 3 17.76V3.83C3 3.37 3.37 3 3.83 3H36.84C37.3 3 37.67 3.37 37.67 3.83V17.75C37.67 18.21 37.3 18.58 36.84 18.58L36.85 18.59ZM4.67 16.92H36.02V4.67H4.67V16.93V16.92Z"/>
