...
export const ZoomOutMinusShrink32 = ({
  color = 'currentColor',
  className,
  style,
}: IconProps) => (
  <svg viewBox="0 0 32 32" width={32} height={32}
    ...
    <g clip-path="url(#clip0_2055_262)">
...
<path d="M8.11 14.93C7.66 14.93 7.29 14.56 7.29 14.11C7.29 13.66 7.66 13.29 8.11 13.29H20.12C20.57 13.29 20.94 13.66 20.94 14.11C20.94 14.56 20.57 14.93 20.12 14.93H8.11Z" fill="black"/>
</g>
<defs>
