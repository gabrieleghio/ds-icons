...
export const renderCameraPhoto24 = ({
  ...
  html`<svg viewBox="0 0 24 24" width="24" height="24"
    ...
    ${unsafeSVG(`<g clip-path="url(#clip0_2055_835)">
<path d="M11.68 17.15C9.48 17.15 7.68 15.36 7.68 13.15C7.68 10.94 9.47 9.15 11.68 9.15C13.89 9.15 15.68 10.94 15.68 13.15C15.68 15.36 13.89 17.15 11.68 17.15ZM11.68 10.67C10.31 10.67 9.19 11.79 9.19 13.16C9.19 14.53 10.3 15.65 11.68 15.65C13.06 15.65 14.17 14.53 14.17 13.16C14.17 11.79 13.05 10.67 11.68 10.67Z"/>
