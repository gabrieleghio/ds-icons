...
export const Downloaded24 = ({
  ...
  <svg viewBox="0 0 24 24" width={24} height={24}
    ...
    <path d="M1.83 21.95C1.37 21.95 1 21.58 1 21.12V16.05C1 15.59 1.37 15.22 1.83 15.22C2.29 15.22 2.66 15.59 2.66 16.05V20.17C2.66 20.24 2.71 20.29 2.78 20.29H20.72C20.79 20.29 20.84 20.24 20.84 20.17V16.05C20.84 15.59 21.21 15.22 21.67 15.22C22.13 15.22 22.5 15.59 22.5 16.05V21.12C22.5 21.58 22.13 21.95 21.67 21.95H1.83Z" fill="black"/>
