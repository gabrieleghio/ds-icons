...
export const ProductCatalogueGridFilled40 = ({
  ...
  <svg viewBox="0 0 40 40" width={40} height={40}
    ...
    <path d="M17.74 3H3.83C3.3716 3 3 3.3716 3 3.83V17.74C3 18.1984 3.3716 18.57 3.83 18.57H17.74C18.1984 18.57 18.57 18.1984 18.57 17.74V3.83C18.57 3.3716 18.1984 3 17.74 3Z"/>
