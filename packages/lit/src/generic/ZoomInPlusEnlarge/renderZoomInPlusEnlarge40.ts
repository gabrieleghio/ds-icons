...
export const renderZoomInPlusEnlarge40 = ({
  color = 'currentColor',
  className,
}: IconProps) =>
  html`<svg viewBox="0 0 40 40" width="40" height="40"
       fill="${color}" class="${className ?? ''}" aria-hidden="true" focusable="false">
    ${unsafeHTML(`<g clip-path="url(#clip0_2055_240)">
...
<path d="M24.46 16.12H17.78V9.44C17.78 8.98 17.41 8.61 16.95 8.61C16.49 8.61 16.12 8.98 16.12 9.44V16.12H9.44C8.98 16.12 8.61 16.49 8.61 16.95C8.61 17.41 8.98 17.78 9.44 17.78H16.12V24.45C16.12 24.91 16.49 25.28 16.95 25.28C17.41 25.28 17.78 24.91 17.78 24.45V17.78H24.46C24.92 17.78 25.29 17.41 25.29 16.95C25.29 16.49 24.92 16.12 24.46 16.12Z" fill="black"/>
</g>
<defs>
<clipPath id="clip0_2055_240">
