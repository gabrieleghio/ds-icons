...
export const WashDryNormal20 = ({
  ...
  <svg viewBox="0 0 20 20" width={20} height={20}
    ...
    <path d="M9.98 16.65C6.3 16.65 3.31 13.66 3.31 9.98C3.31 6.3 6.3 3.31 9.98 3.31C13.66 3.31 16.65 6.3 16.65 9.98C16.65 13.66 13.66 16.65 9.98 16.65ZM9.98 4.57C7 4.57 4.57 7 4.57 9.98C4.57 12.96 7 15.39 9.98 15.39C12.96 15.39 15.39 12.96 15.39 9.98C15.39 7 12.96 4.57 9.98 4.57Z"/>
