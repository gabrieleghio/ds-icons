...
export const ProductCatalogueGridFilled16 = ({
  ...
  <svg viewBox="0 0 16 16" width={16} height={16}
    ...
    <path d="M1.58 1H7.14C7.46 1 7.72 1.26 7.72 1.58V7.14C7.72 7.46 7.46 7.72 7.14 7.72H1.58C1.26 7.72 1 7.46 1 7.14V1.59C1 1.27 1.26 1.01 1.58 1.01V1Z" fill="black"/>
