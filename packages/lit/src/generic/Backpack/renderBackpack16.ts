...
export const renderBackpack16 = ({
  ...
  html`<svg viewBox="0 0 16 16" width="16" height="16"
    ...
    ${unsafeHTML(`<path fill="#000" d="M4.54 12.63c0 .58.47 1.06 1.06 1.06h3.98c.58 0 1.06-.47 1.06-1.06v-2.48H4.55v2.48h-.01Zm1.17-1.32h3.75l-.03 1.21-3.72-.04v-1.17Z"/>
