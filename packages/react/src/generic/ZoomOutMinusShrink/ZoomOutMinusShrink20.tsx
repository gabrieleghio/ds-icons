...
export const ZoomOutMinusShrink20 = ({
  color = 'currentColor',
  className,
  style,
}: IconProps) => (
  <svg viewBox="0 0 20 20" width={20} height={20}
    ...
    <g clip-path="url(#clip0_2055_268)">
...
<path d="M4.93 9.32C4.58 9.32 4.3 9.04 4.3 8.69C4.3 8.34 4.58 8.06 4.93 8.06H12.44C12.79 8.06 13.07 8.34 13.07 8.69C13.07 9.04 12.79 9.32 12.44 9.32H4.93Z"/>
</g>
<defs>
